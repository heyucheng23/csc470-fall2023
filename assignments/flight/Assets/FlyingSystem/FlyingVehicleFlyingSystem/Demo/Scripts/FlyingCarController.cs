...
public class FlyingCarController : MonoBehaviour
{
    ...
    public void TakeOffOrLand()
    {
        if (flyingVehicleFlyingSystem.inAir)
        {
            ...
            rootRigidbody.drag = 0.0f;
            rootRigidbody.angularDrag = 0.0f;
        ...
        else
        {
            ...
            // Set drag and angular drag to very large value to avoid being pushed and won't stop
            rootRigidbody.drag = 1000.0f;
            rootRigidbody.angularDrag = 1000.0f;
